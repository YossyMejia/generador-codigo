...
// If not, reports a syntactic error.
  ...
  boolean accept (int tokenExpected) throws SyntaxError {
...
///////////////////////////////////////////////////////////////////////////////
  ...
  public Program parseProgram() {
    ...
    lexicalAnalyser.finishScan();           //MODIFICADO
    writer.write(programAST);               //MODIFICADO
    return programAST;
  }
...
//
///////////////////////////////////////////////////////////////////////////////
   Command parseRestIfCommand() throws SyntaxError {        //MODIFICADO
    Command commandAST = null; // in case there's a syntactic error
...
///////////////////////////////////////////////////////////////////////////////
  ...
  Declaration parseDeclaration() throws SyntaxError {           //MODIFICADO
  ...
  Declaration parseCompoundDeclaration() throws SyntaxError { //MODIFICADO
    Declaration dAST = null; // in case there's a syntactic error
  ...
  Declaration parseProcSingle() throws SyntaxError {        //MODIFICADO
